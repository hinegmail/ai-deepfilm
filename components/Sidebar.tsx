        ...
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`w-full flex items-center justify-between px-4 py-4 transition-all duration-200 group relative rounded-2xl border ${isActive
            ...
            >
              <div className="flex items-center gap-3">
                <span className={`w-8 h-8 rounded-xl flex items-center justify-center border ${isActive ? 'bg-cyan-300/15 border-cyan-200/25' : 'bg-slate-900/70 border-white/5 group-hover:border-white/10'
                  }`}>
